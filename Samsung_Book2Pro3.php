...
<head>
    ...
    <title>Galaxy Book2 Pro 360 (13.3", i5, 16GB)</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://i.expansys.net/i/b/b376325-1.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Galaxy Book2 Pro 360 (13.3", i5, 16GB)</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                        <li>360 度輕薄時尚的二合一創意</li>
                            <li>附 S Pen</li>
                            <li>Intel® Core™ i5-1240P</li>
                            <li>AKG 和杜比全景聲 (Dolby Atmos) 音頻</li>
                            <li>Wi-Fi 6E </li>
                            <li>13.3 inches FHD</li>
