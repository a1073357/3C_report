...
<head>
    ...
    <title>MacBook Pro 16吋 1TB SSD 儲存裝置</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">MacBook Pro 16吋 1TB SSD 儲存裝置</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>10 核心 CPU 16 核心 GPU 16GB 統一記憶體 1TB SSD 儲存裝置</li>
                            <li>16 核心神經網路引擎</li>
