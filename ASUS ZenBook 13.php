...
<head>
    ...
    <title>華碩 ASUS ZenBook 13</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">華碩 ASUS ZenBook 13</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>ASUS ZenBook 13 恆 • 美力</li>
                            <li>13.3" FHD (1920 x 1080) OLED</li>
                            <li>Intel Core i5-1135G7 Processor 2.4 GHz</li>
                            <li>16GB LPDDR4X on board</li>
                            <li>512GB M.2 NVMe PCIe 3.0 SSD</li>
			    <li>Intel Iris X Graphics</li>
			    <li>螢幕88%屏佔比/重量1.1kg</li>
                        </ul>
                        <hr>
                        <h5>NT$ 29999</h5>
                        <hr>
                        <p>顏色：綠松灰色<input type="radio" name="role" value="綠松灰色">
				 星河紫色<input type="radio" name="role" value="星河紫色">
                        </p>
