        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Vivobook Pro 15</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>最高第 11 代 Intel® H 系列處理器</li>
                            <li>最高 NVIDIA® GeForce® RTX 3050</li>
                            <li>最高 16 GB 記憶體</li>
                            <li>最高 512 GB SSD 儲存空間</li>
                            <li>最高 15.6 吋 NanoEdge 窄邊框螢幕</li>
			    <li>ASUS WiFi Master Premium 技術</li>
			    <li>視訊鏡頭遮罩</li>
                        </ul>
                        <hr>
                        <h5>NT$ 34900</h5>
