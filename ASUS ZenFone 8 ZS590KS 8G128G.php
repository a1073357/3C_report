...
<head>
    ...
    <title>ASUS ZenFone 8 ZS590KS 8G/128G</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS ZenFone 8 ZS590KS 8G/128G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>5.9吋 20:9 AMOLED螢幕</li>
                            <li>120Hz/1ms動態畫質更新率</li>
                            <li>高通S888 5G處理器</li>
                            <li>8G RAM / 128G ROM</li>
                            <li>Sony旗艦級IMX686 6400萬像素感光元件</li>
      			    <li>四軸OIS光學防手震</li>
			    <li>雙立體聲喇叭搭配 Dirac HD Sound音訊技術</li>
	 		    <li>IP65/IP68防水防塵</li>
			    <li>4000mAh大電量 支援QC4.0快充與PD充電功能</li>
			    <li>支援NFC</li>
                        </ul>
                        <hr>
                        <h5>NT$ 13480</h5>
