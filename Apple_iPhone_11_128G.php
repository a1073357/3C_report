...
<head>
    ...
    <title>Apple iPhone 11 128G</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="/img/Apple iPhone 11 (128G).jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPhone 11 128G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>6.1 吋 Liquid Retina HD LCD 顯示器</li>
                            <li>防潑抗水與防塵功能 (在最深達 2 公尺水中最長可達 30 分鐘，IP68)</li>
                            <li>雙相機系統，具備 1200 萬像素超廣角與廣角相機；夜間模式、人像模式與 4K 影片拍攝功能 (最高可達 60 fps)</li>
                            <li>1200 萬像素原深感測前置相機，具備人像模式、4K 影片與慢動作影片拍攝功能</li>
                            <li>Face ID，用於安全認證與 Apple Pay</li>
                            <li>A13 仿生晶片具備第 3 代神經網路引擎</li>
                            <li>快速充電功能 (需另購相關配件)</li>
                            <li>無線充電</li>
                            <li> iOS 13 具備深色模式、全新的照片與影片編輯工具，以及全新的隱私保護</li>
                        </ul>
                        <hr>
                        <h5>NT$ 17588</h5>
                        <hr>
                        <p>顏色：紫色<input type="radio" name="role" value="紫色">
                              綠色<input type="radio" name="role" value="綠色">
                              黃色<input type="radio" name="role" value="黃色">
                              白色<input type="radio" name="role" value="白色">
                              黑色<input type="radio" name="role" value="黑色">
                              紅色<input type="radio" name="role" value="紅色">
                        </p>
