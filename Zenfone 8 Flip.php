        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Zenfone 8 Flip</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>翻轉視野〔 180度翻轉三鏡頭 〕</li>
                            <li>旗艦高效〔 高通S888 5G處理器 〕</li>
                            <li>真全螢幕〔 螢幕下指紋辨識 〕</li>
                            <li>長效續航〔 5000mAh超大電量 〕</li>
                            <li>1200萬畫素超廣角鏡頭</li>
                        </ul>
                        <hr>
                        <h5>NT$ 18990</h5>
                        <hr>
                        <p>顏色：流光銀色<input type="radio" name="role" value="流光銀色">
                              晶礦黑色<input type="radio" name="role" value="晶礦黑色">
                        </p>
