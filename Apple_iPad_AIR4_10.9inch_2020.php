...
<head>
    ...
    <title>2020 Apple iPad AIR 4 10.9吋</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">2020 Apple iPad AIR 4 10.9吋 LTE 256G 平板電腦</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>10.9吋 Retina顯示器</li>
                            <li>64 位元 A14 仿生晶片</li>
                            <li>TouchID/頂端鈕合而為一</li>
                            <li>前置相機 700 萬像素</li>
                            <li>後置相機 1200 萬像素</li>
                        </ul>
                        <hr>
                        ...
                        <p>顏色：銀色<input type="radio" name="role" value="銀色">
                              灰色<input type="radio" name="role" value="灰色">
