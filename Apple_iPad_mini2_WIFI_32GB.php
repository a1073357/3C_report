...
<head>
    ...
    <title>Apple 蘋果 iPad mini 2 WIFI版 32G 平板電腦</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple 蘋果 iPad mini 2 WIFI版 32G 平板電腦</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>7.9 吋 Retina顯示器</li>
                            <li>A7 晶片與 M7 處理器</li>
                            <li>Multi-Touch 多點觸控顯示器</li>
                            <li>解析度2048×1536</li>
                            <li>1080p HD 錄影功能</li>
                        </ul>
                        <hr>
