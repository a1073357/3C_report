        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://i4.momoshop.com.tw/1651691469/goodsimg/0009/952/162/9952162_R.webp">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Galaxy Tab S8+</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>12.4吋120Hz超流暢螢幕</li>
                            <li>高通4nm 8Gen1處理器</li>
                            <li>8G RAM/128G ROM</li>
                            <li>螢幕指紋辨識</li>
                            <li>1200萬畫素前置鏡頭</li>
                            <li>超快速Wi-Fi 6E</li>
                            <li>超快速充電2.0</li>
                            <li>超大10090mAh超效能表現電池</li>
                            <li>支援新一代 S Pen</li>
                        </ul>
                        <hr>
                        <h5>NT$26,990</h5>
                        <hr>
                        <p>顏色：
                            黑耀灰<input type="radio" name="role" value="黑耀灰">
                            粉霧金<input type="radio" name="role" value="粉霧金">
                        </p>
