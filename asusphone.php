    ...
    <section id="intro">
            <div class="container">
                <div class="row">
                    <!-- md:平板模式；12滿版區 -->
                    <div class="col-md-12">
                    <img class="d-block w-100" src="https://cdn1.techbang.com/system/excerpt_images/86672/original/12b370c6cdc203dd8bec77886ae15b35.jpg?1620834589" alt="First slide">
                    </div>
                </div>
            </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper1">
                            <a href="ASUS ZenFone 8 ZS590KS 8G128G.php"><img src="/img/asusphone1.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$13480</h3>
                                <span><i class=""></i>ASUS ZenFone 8 ZS590KS 8G/128G</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <div class="tab1"><b>暢銷</b></div>
                            <a href="Zenfone 8 Flip.php"><img src="/img/asusphone2.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT18990</h3>
                                <span><i class=""></i>Zenfone 8 Flip</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="ASUS ZenFone 7 5G.php"><img src="/img/asusphone3.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$14666</h3>
                                <span><i class=""></i>ASUS ZenFone 7 5G (8G/128G) 6.67吋 翻轉三鏡頭</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="ROG Phone 5s.php"><img src="/img/asusphone4.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$27990</h3>
                                <span><i class=""></i>ROG Phone 5s</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <div class="tab1"><b>福利品</b></div>
                            <a href="ASUS 華碩 ROG Phone 3.php"><img src="/img/asusphone5.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                            <span style="font-size: 30px; text-decoration:line-through">NT$29990</span>
                                <span style="font-size: 25px">NT$13000</span><br>
                                <span><i class=""></i>ASUS 華碩 ROG Phone 3</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="ASUS ROG PHONE II.php"><img src="/img/asusphone6.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$25000</h3>
                                <span><i class=""></i>ASUS ROG PHONE II</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
