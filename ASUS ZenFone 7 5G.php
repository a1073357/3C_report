        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS ZenFone 7 5G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                        ...
                        <h5>NT$ 14666</h5>
                        <hr>
                        <p>顏色：煥彩白色<input type="radio" name="role" value="煥彩白色">
                              宇曜黑色<input type="radio" name="role" value="宇曜黑色">
                        </p>
