...
<head>
    ...
    <title>Apple iPhone 12 Pro Max 512G</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="/img/Apple iPhone 12 Pro Max 512G.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPhone 12 Pro Max 512G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>6.7 吋超 Retina XDR 顯示器</li>
                            <li>Ceramic Shield，帶來4倍耐摔的優異表現</li>
                            <li>5G 帶來超快下載，搭配智慧型數據模式更可省電</li>
                            <li>A14 仿生晶片，智慧型手機中歷來最快速的晶片</li>
                            <li>專業級相機系統，配備1200萬像素超廣角、廣角與望遠相機；5倍光學變焦範圍；夜間模式、深度融合、智慧型HDR 3、Apple ProRAW5、4K杜比視界 HDR 錄製</li>
                            <li>光學雷達掃描儀帶來更出色的 AR 體驗，以及夜間模式人像拍攝</li>
                            <li>1200 萬像素原深感測前置相機，具備夜間模式、4K杜比視界 HDR 錄製</li>
                            <li>領先業界的 IP68 等級防潑抗水功能</li>
                            <li>支援 MagSafe 配件，可輕鬆貼合，無線充電更快捷</li>
                            <li>iOS 14 具備主畫面上眾多重新設計的小工具，以及全新的App資料庫、輕巧App等功能</li>
                        </ul>
                        <hr>
                        <h5>NT$ 32999</h5>
                        <hr>
                        <p>顏色：銀色<input type="radio" name="role" value="銀色">
                              石墨色<input type="radio" name="role" value="石墨色">
                              金色<input type="radio" name="role" value="金色">
                              太平洋藍色<input type="radio" name="role" value="太平洋藍色">
                        </p>
