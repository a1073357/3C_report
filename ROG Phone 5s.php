        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ROG Phone 5s</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>6.78吋AMOLED 144Hz/1ms動態畫質</li>
                            <li>360Hz原生觸控取様率</li>
                            <li>16G RAM / 256G ROM</li>
                            <li>6400 萬畫素 Sony® IMX686廣角旗艦鏡頭</li>
                            <li>Ultra雙正面立體聲揚聲器</li>
			    <li>GameFX 音訊系統/內建四麥克風搭配</li>
			    <li>ASUS降噪技術/ESS技術</li>
			    <li>6000mAh超大電量</li>
                        </ul>
                        <hr>
                        <h5>NT$ 27990</h5>
