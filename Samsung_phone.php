        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper1">
                            <a href="Samsung_Fold3.php"><img class="d-block w-100" src="https://alhaddadshop.com/images/thumbs/0021967_samsung-galaxy-z-fold3-256-gb-5g-phantom-black.jpeg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$48,800</h3>
                                <span><i class=""></i>Samsung Z Fold3</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                ...
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Samsung_Flip3.php"><img class="d-block w-100" src="https://alhaddadshop.com/images/thumbs/0029133_samsung-galaxy-z-flip3-256gb-5g-8gb-ram-phantom-black_510.jpeg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$32,800</h3>
                                <span><i class=""></i>Samsung Z Filp3</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                ...
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Samsung_Fold2.php"><img class="d-block w-100" src="https://s.yimg.com/zp/MerchandiseImages/CE45AF2D0F-SP-10377398.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$45,000</h3>
                                <span><i class=""></i>Samsung Z Fold2</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Samsung_s22Ultra.php"><img class="d-block w-100" src="https://s.yimg.com/zp/MerchandiseImages/F7A116E288-Product-29277058.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$34,900</h3>
                                <span><i class=""></i>Samsung s22 Ultra</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Samsung_s22Plus.php"><img class="d-block w-100" src="https://s.yimg.com/zp/MerchandiseImages/90A6DAE250-SP-11369311.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$28,900</h3>
                                <span><i class=""></i>Samsung s22 Plus</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Samsung_s22.php"><img class="d-block w-100" src="https://s.yimg.com/zp/MerchandiseImages/E4EC62C57D-SP-10948264.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$25,900</h3>
                                <span><i class=""></i>Samsung s22</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
