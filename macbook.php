        ...
        <div class="jumbotron2">
            <div class="container">
                <div class="row">
                    <!-- md:平板模式；12滿版區 -->
                    <div class="col-md-12">
                        <a class="btn4" href="#last1">SHOP NOW</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper1">
                            <a href="MacBook Pro 13吋 256GB SSD 儲存裝置.php"><img src="/img/MacBook1.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$39900</h3>
                                <span><i class=""></i>MacBook Pro 13吋 <span style="color:red;">256GB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="MacBook Pro 13吋 512GB SSD 儲存裝置.php"><img src="/img/MacBook2.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT45900</h3>
                                <span><i class=""></i>MacBook Pro 13吋 <span style="color:red;">512GB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="MacBook Pro 14吋 512GB SSD 儲存裝置.php"><img src="/img/MacBook3.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$59900</h3>
                                <span><i class=""></i>MacBook Pro 14吋 <span style="color:red;">512GB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="MacBook Pro 14吋 1TB SSD 儲存裝置.php"><img src="/img/MacBook4.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$74900</h3>
                                <span><i class=""></i>MacBook Pro 14吋 <span style="color:red;">1TB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="MacBook Pro 16吋 512GB SSD 儲存裝置.php"><img src="/img/MacBook5.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$74900</h3>
                                <span><i class=""></i>MacBook Pro 16吋 <span style="color:red;">512GB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="MacBook Pro 16吋 1TB SSD 儲存裝置.php"><img src="/img/MacBook6.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$80900</h3>
                                <span><i class=""></i>MacBook Pro 16吋 <span style="color:red;">1TB</span> SSD 儲存裝置</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
