    ...
    <section id="last">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6" id="close2">
                    <div class="outer">
                        <div class="lower text-center">
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            <input class="form-control mr-sm-2" type="search" placeholder="姓名" aria-label="Search" >
                            </form>
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            <input class="form-control mr-sm-2" type="search" placeholder="帳號" aria-label="Search" >
                            </form>
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            <input class="form-control mr-sm-2" type="search" placeholder="密碼" aria-label="Search" >
                            </form>
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            <input class="form-control mr-sm-2" type="search" placeholder="生日" aria-label="Search">
                            </form>
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            ...
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                            <input class="form-control mr-sm-2" type="search" placeholder="電話" aria-label="Search">
                            </form>
                            <br>
                            <form class="form-inline my-2 my-lg-0">
                                <input class="form-control mr-sm-2" type="search" placeholder="建議/想與我說?" aria-label="Search">
                                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">註冊</button>
                            </form>
                            <br>
                        </div>
                    </div>
