        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://cs-b.ecimg.tw/items/DYALFPA900BG88N/000001_1624608147.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Galaxy Tab A7Lite</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            ...
                            <li>8.7吋大螢幕</li>
                            <li>智慧臉部辨識</li>
                            <li>輕巧機身賦予其不受空間限制的行動力</li>
                            <li>內建Samsung Kids兒童模式提供多款數位遊戲</li>
