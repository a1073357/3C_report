    ...
    <section id="intro">
            <div class="container">
                <div class="row">
                    <!-- md:平板模式；12滿版區 -->
                    <div class="col-md-12">
                    <img class="d-block w-100" src="https://m.media-amazon.com/images/S/aplus-media/vc/a9c9715d-7ab3-406f-844f-228b003258e4.__CR0,0,1464,600_PT0_SX1464_V1___.jpg" alt="First slide">
                    </div>
                </div>
            </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper1">
                            <a href="ASUS Chromebook Tablet CT100.php"><img src="/img/asuspaid1.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$11900</h3>
                                <span><i class=""></i>ASUS Chromebook Tablet CT100</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="ASUS Chromebook CZ1000DVA.php"><img src="/img/asuspaid2.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT11888</h3>
                                <span><i class=""></i>ASUS Chromebook CZ1000DVA</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="ASUS Chromebook CX5500FEA.php"><img src="/img/asuspaid3.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$26880</h3>
                                <span><i class=""></i>ASUS Chromebook CX5500FEA</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
