...
<head>
    ...
    <title>Vivobook Pro 16X OLED</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Vivobook Pro 16X OLED</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>最高 AMD Ryzen™ 5000 H 系列處理器</li>
                            <li>最高 NVIDIA® GeForce® RTX 3050 Ti</li>
                            <li>最高 32 GB 記憶體</li>
                            <li>最高 1 TB SSD 儲存空間</li>
                            <li>最高 16'' 4K OLED NanoEdge 螢幕</li>
			    <li>ASUS DialPad 虛擬繪圖旋鈕</li>
			    <li>Pantone 認證螢幕</li>
                        </ul>
                        <hr>
                        <h5>NT$ 48900</h5>
