...
<head>
    ...
    <title>Apple iPhone 13 256G</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="/img/new_pd1_iPhone_13.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPhone 13 (256G)</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>6.1 吋超 Retina XDR 顯示器</li>
                            <li>電影級模式為影片增添淺景深效果，並自動變換焦點</li>
                            <li>先進的雙相機系統，配備 1200 萬像素廣角與超廣角相機；具備攝影風格、智慧型 HDR 4、夜間模式、4K 杜比視界 HDR 錄製</li>
                            <li>1200 萬像素原深感測前置相機</li>
                            <li>具備夜間模式、4K 杜比視界 HDR 錄製</li>
                            <li>A15 仿生晶片，效能表現快如閃電</li>
                            <li>影片播放時間最長可達 19 小時</li>
                            <li>領先業界的 IP68 等級防潑抗水功能</li>
                            <li>5G 帶來超快速下載與高品質串流播放</li>
                            <li>iOS 15滿載全新功能而來，讓你的iPhone能比以往做到更多，支援 MagSafe 配件，可輕鬆貼合，無線充電更快捷</li>
                        </ul>
                        <hr>
                        <h5>NT$ 27288</h5>
                        <hr>
                        <p>顏色：紅色<input type="radio" name="role" value="紅色">
                              星光色<input type="radio" name="role" value="星光色">
                              午夜色<input type="radio" name="role" value="午夜色">
                              藍色<input type="radio" name="role" value="藍色">
                              粉紅色<input type="radio" name="role" value="粉紅色">
                        </p>
