        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://s.yimg.com/zp/MerchandiseImages/CE45AF2D0F-SP-10377398.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Samsung Z Fold 2</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>7.6吋無邊際展開式螢幕</li>
                            <li>可折疊超薄玻璃螢幕</li>
                            <li>隱藏式轉軸設計，鉸鏈轉軸更順暢</li>
                            <li>高通S865+ 5G旗艦處理器</li>
                        </ul>
                        <hr>
                        <h5>NT$48,800</h5>
                        <hr>
                        <p>顏色：
                            星霧金<input type="radio" name="role" value="星霧金">
                            星幻黑<input type="radio" name="role" value="星幻黑">
                        </p>
