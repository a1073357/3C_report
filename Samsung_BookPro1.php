...
<head>
    ...
    <title>Galaxy Book Pro 360 5G (13.3", i7, 16GB)</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://i.expansys.net/img/b/359880/samsung-galaxy-book-pro-360-13-3-1080p-touch-screen.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Galaxy Book Pro 360 5G (13.3", i7, 16GB)</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                        <li>360 度輕薄時尚的二合一創意</li>
                            <li>附 S Pen</li>
                            <li>Intel i7-1165G7</li>
                            <li>AKG 和杜比全景聲 (Dolby Atmos) 音頻</li>
                            <li>Wi-Fi 6E </li>
                            <li>13.3" 1080P Touch Screen</li>
