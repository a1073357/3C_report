                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        ...
                        <ul>
                            <p>商品特色</p>
                            <li>輕薄1.05kg</li>
                            <li>處理器：Intel® Celeron® N4020 1.1 GHz</li>
                            <li>LCD尺寸：11.6"HD 霧面寬螢幕 (LED)</li>
                            <li>記憶體：4GB DDR4 on board</li>
                            <li>容量：64GB EMMC</li>
			    <li>無線網路：Wi-Fi 5(802.11ac)+Bluetooth 4.1 (Dual band) 1*1</li>
			    <li>其他：HDMI、USB 3.2</li>
			    <li>作業系統：Windows 10 Home S (S模式)</li>
			    <li>無讀卡機版本</li>
                        </ul>
                        <hr>
                        <h5>NT$ 19990</h5>
                        <hr>
                        <p>顏色：夢幻白色<input type="radio" name="role" value="夢幻白色">
				 夢想藍色<input type="radio" name="role" value="夢想藍色">
				 玫瑰金色<input type="radio" name="role" value="玫瑰金色">
                        </p>
