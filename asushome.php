    ...
    <section id="intro">
            <div class="container">
                <div class="row">
                    <!-- md:平板模式；12滿版區 -->
                    <div class="col-md-12">
                    <img class="d-block w-100" src="https://smb.asus.com/uimg/productbanner/20210406120525928pad.jpg" alt="First slide">
                    </div>
                </div>
            </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="row text-center">
                    <div class="col-md-6" id="close">
                        <div class="outer">
                            <div class="rwd-map">
                            <iframe src="https://www.youtube.com/embed/OP7S32a4ohw" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" id="close1">
                        <div class="outer">
                            <div class="lower text-center">
                                <br><br><br><br><br><br><br><br>
                                    <h3 style="color: darkgoldenrod;">Introducing Zenfone 8 | ASUS</h3>
                                <br><br><br><br><br><br><br><br>
                                    </div>
                            </div>
                        </div>
                        <div class="col-md-6" id="close">
                            <div class="outer">
                                <div class="rwd-map">
                                    <iframe src="https://www.youtube.com/embed/WzWAfdTYvv4" frameborder="0"></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" id="close1">
                            <div class="outer">
                                <div class="lower text-center">
                                    <br><br><br><br><br><br><br><br>
                                        <h3 style="color: darkgoldenrod;">Versatile power for work and play -ASUS Chromebook Flip CX3</h3>
                                        <br><br><br><br><br><br><br><br>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-6" id="close">
                                <div class="outer">
                                    <div class="rwd-map">
                                        <iframe src="https://www.youtube.com/embed/FR1UCkCH5PM" frameborder="0"></iframe>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" id="close1">
                                <div class="outer">
                                    <div class="lower text-center">
                                        <br><br><br><br><br><br><br>
                                            <h3 style="color: darkgoldenrod;">Incredible Comes From Lightness – ASUS Zenbook S 13 OLED</h3>
                                            <br><br><br><br><br><br><br>
                                            </div>
                                    </div>
                                </div>
