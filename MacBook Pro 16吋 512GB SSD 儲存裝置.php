...
<head>
    ...
    <title>MacBook Pro 16吋 512GB SSD 儲存裝置</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">MacBook Pro 16吋 512GB SSD 儲存裝置</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>10 核心 CPU 16 核心 GPU 16GB 統一記憶體 512GB SSD 儲存裝置</li>
                            <li>16 核心神經網路引擎</li>
                            <li>16 吋 Liquid Retina XDR 顯示器</li>
                            <li>三個 Thunderbolt 4 埠、HDMI 埠、SDXC 卡插槽、MagSafe 3 埠</li>
                            <li>含 Touch ID 的巧控鍵盤</li>
                            <li>力度觸控板</li>
                            <li>140W USB-C 電源轉接器</li>
                        </ul>
                        <hr>
                        <h5>NT$ 74900</h5>
                        <hr>
