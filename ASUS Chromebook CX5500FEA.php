...
<head>
    ...
    <title>ASUS Chromebook CX5500FEA</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS Chromebook CX5500FEA</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>處理器：Intel® Core™ i5-1135G7 Processor 2.4 GHz</li>
                            <li>記憶體：16G LPDDR4X on board</li>
                            <li>硬碟：256GB M.2 NVMe PCIe 3.0 SSD</li>
                            <li>LCD尺寸：15.6 FHD IPS 霧面觸控</li>
                            <li>其他：Type-C support display / power delivery、HDMI</li>
			    <li>作業系統：Google Chrome</li>
                        </ul>
                        <hr>
                        <h5>NT$ 26880</h5>
                        <hr>
