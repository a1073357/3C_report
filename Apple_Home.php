            ...
            <div class="row">
                ...
                <div class="row text-center">
                    <div class="col-md-6" id="close">
                        <div class="outer">
                            <div class="rwd-map">
                            <iframe src="https://www.youtube.com/embed/kV__iZuxDGE" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" id="close1">
                        <div class="outer">
                            <div class="lower text-center">
                                <br><br><br><br><br><br><br>
                                    <h3 style="color: darkgoldenrod;">iPhone 13 & iPhone 13 Pro | Now in Green | Apple</h3>
                                <br><br><br><br><br><br><br>
                                    </div>
                            </div>
                        </div>
                        <div class="col-md-6" id="close">
                            <div class="outer">
                                <div class="rwd-map">
                                    <iframe src="https://www.youtube.com/embed/GByi_j-7Q2E" frameborder="0"></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" id="close1">
                            <div class="outer">
                                <div class="lower text-center">
                                    <br><br><br><br><br><br><br><br>
                                        <h3 style="color: darkgoldenrod;">The new iPhone SE | A15 Bionic + 5G | Apple</h3>
                                        <br><br><br><br><br><br><br><br>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-6" id="close">
                                <div class="outer">
                                    <div class="rwd-map">
                                        <iframe src="https://www.youtube.com/embed/I-t2mwrYc6s" frameborder="0"></iframe>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" id="close1">
                                <div class="outer">
                                    <div class="lower text-center">
                                        <br><br><br><br><br><br><br><br><br>
                                            <h3 style="color: darkgoldenrod;">The new iPad Air | Now with M1 | Apple</h3>
                                            <br><br><br><br><br><br><br>
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-6" id="close">
                                    <div class="outer">
                                        <div class="rwd-map">
                                            <iframe src="https://www.youtube.com/embed/gdeqbg8QFJM" frameborder="0" ></iframe>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" id="close1">
                                    <div class="outer">
                                        <div class="lower text-center">
                                            <br><br><br><br><br><br><br><br>
                                                <h3 style="color: darkgoldenrod;">Introducing the all-new iPad mini | Apple</h3>
                                                <br><br><br><br><br><br><br><br>
                                                </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6" id="close">
                                        <div class="outer">
                                            <div class="rwd-map">
                                                <iframe src="https://www.youtube.com/embed/9tobL8U7dQo" frameborder="0"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6" id="close1">
                                        <div class="outer">
                                            <div class="lower text-center">
                                                <br><br><br><br><br><br><br>
                                                    <h3 style="color: darkgoldenrod;">The new MacBook Pro | Supercharged for pros | Apple</h3>
                                                    <br><br><br><br><br><br><br>
                                                    </div>
                                            </div>
                                        </div>
