...
<head>
    ...
    <title>Apple iPhone 12 128G</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPhone 12 128G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            ...
                            <li>先進的雙相機系統，配備 1200 萬像素超廣角與廣角相機；夜間模式、深度融合、智慧型HDR 3、4K杜比視界HDR錄製</li>
                            <li>1200 萬像素原深感測前置相機，具備夜間模式、4K杜比視界HDR錄製</li>
                        ...
                        <p>顏色：黑色<input type="radio" name="role" value="黑色">
                              ...
                              紫色<input type="radio" name="role" value="紫色">
                        </p>
