...
<head>
    ...
    <title>Galaxy Book2 Pro 360 (15.6", i7, 16GB)</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://i.expansys.net/i/b/b376324-3.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Galaxy Book2 Pro 360 (15.6", i7, 16GB)</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                        ...
                        <hr>
                        <p>顏色：
                            暗酒紅<input type="radio" name="role" value=" 暗酒紅">
                            炭灰黑<input type="radio" name="role" value="炭灰黑">
                        </p>
