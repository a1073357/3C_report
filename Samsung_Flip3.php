        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://s.yimg.com/zp/MerchandiseImages/69DDA84F0B-SP-11307897.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Samsung Z Flip 3</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>6.7吋折疊屏+外螢幕1.9吋</li>
                            <li>12MP雙主鏡頭+前鏡10MP</li>
                            <li>高通S888八核心5nm處理器</li>
                            <li>摺疊可達20萬次/防水IPX8</li>
                            <li>3300mAh、支援15W閃充</li>
                        </ul>
                        <hr>
                        <h5>NT$32,800</h5>
                        <hr>
                        <p>顏色：
                            絨絲白<input type="radio" name="role" value="絨絲白">
                            幻影黑<input type="radio" name="role" value="幻影黑">
                            石墨綠<input type="radio" name="role" value="石墨綠">
                            日落紫<input type="radio" name="role" value="日落紫">
                        </p>
