...
<head>
    ...
    <title>Apple 2022 iPad Air 5 Wi-Fi</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple 2022 iPad Air 5 Wi-Fi+行動網路 64G 10.9吋 平板電腦</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>Liquid Retina顯示</li>
                            <li>M1晶片驅動 60%效能提升</li>
                            <li>1200 萬像素超廣角前置相機</li>
                            <li>可搭檔Pencil和巧控鍵盤</li>
                            <li>急速 5G</li>
                        </ul>
                        <hr>
                        <h5>NT$ 22900</h5>
