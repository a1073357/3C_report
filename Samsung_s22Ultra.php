        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://s.yimg.com/zp/MerchandiseImages/9B0E114329-Product-28307705.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Samsung S22Ultra</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>Z系列首度支援 S Pen</li>
                            <li>摺疊首款螢幕下鏡頭款螢幕下鏡頭</li>
                            <li>全方位多工/娛樂效能</li>
                            <li>IPX8 防水等級</li>
                            <li>6.8吋120Hz超流暢螢幕</li>
                            <li>1.08億 四主鏡頭</li>
                            <li>100X超高倍變焦</li>
                        </ul>
                        <hr>
                        ...
                        <hr>
                        <p>顏色：
                            皎月白<input type="radio" name="role" value="皎月白">
                            星際黑<input type="radio" name="role" value="星際黑">
                            極光綠<input type="radio" name="role" value="極光綠">
                            雪霧粉<input type="radio" name="role" value="雪霧粉">
                        </p>
