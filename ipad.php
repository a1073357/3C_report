        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper1">
                            <a href="Apple 2022 iPad Air 5 Wi-Fi.php"><img src="/img/ipad1.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$22900</h3>
                                <span><i class=""></i>Apple 2022 iPad Air 5 Wi-Fi+行動網路 64G 10.9吋 平板電腦</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="2020 Apple iPad AIR 4 10.9吋.php"><img src="/img/ipad2.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT28200</h3>
                                <span><i class=""></i>2020 Apple iPad AIR 4 10.9吋 LTE 256G 平板電腦</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Apple iPad 9 2021 10.2吋 WIFI 64G.php"><img src="/img/ipad3.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$10700</h3>
                                <span><i class=""></i>Apple iPad 9 2021 10.2吋 WIFI 64G 平板電腦</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="Apple 2021 iPad mini 6平板電腦.php"><img src="/img/ipad4.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$18624</h3>
                                <span><i class=""></i>Apple 2021 iPad mini 6平板電腦</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            ...
                            <a href="Apple 蘋果 iPad mini 2 WIFI版 32G 平板電腦.php"><img src="/img/ipad5.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$3990</h3>
                                <span><i class=""></i>Apple 蘋果 iPad mini 2 WIFI版 32G 平板電腦</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
                <div class="col-md-4">
                        <div class="outer">
                            <div class="upper">
                            <a href="2021年款 iPad Pro 11吋 第3代 M1 晶片 WiFi 128GB.php"><img src="/img/ipad6.jpg" alt=""></a>
                            </div>
                            <div class="lower text-center">
                                <h3>NT$23999</h3>
                                <span><i class=""></i>2021年款 iPad Pro 11吋 第3代 M1 晶片 WiFi 128GB</span><br>
                                <button>加入購物車</button>
                            </div>
                        </div>
                </div>
