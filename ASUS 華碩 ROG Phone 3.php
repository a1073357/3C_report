...
<head>
    ...
    <title>ASUS 華碩 ROG Phone 3</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS 華碩 ROG Phone 3</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>5G + 4G 雙卡雙待</li>
                            <li>Android 10 作業系統</li>
                            <li>6.59 吋 2,340 x 1,080pixels 解析度 AMOLED 觸控螢幕（144Hz 螢幕更新率</li>
                            <li>Qualcomm Snapdragon 865+, 3.091GHz 八核心處理器</li>
                            <li>12GB RAM / 512GB ROM</li>
			    <li>2,400 萬畫素前鏡頭</li>
			    <li>6,400 萬畫素 + 1,300 萬畫素 + 500 萬畫素主相機</li>
			    <li>Wi-Fi 6、藍牙 5.1、NFC</li>
			    <li>超音波感觸鍵</li>
			    <li>螢幕指紋辨識、臉部解鎖</li>
			    <li>6,000mAh 電池</li>
			    <li>採用 USB Type-C 規格，支援 30W 有線快充</li>
                        </ul>
                        <hr>
                        <h5>NT$ 13000</h5>
                        <hr>
