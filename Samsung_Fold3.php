        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="https://s.yimg.com/zp/MerchandiseImages/D51EB5C1C7-SP-10694053.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Samsung Z Fold 3</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                        ...
                        <p>顏色：
                            ...
                            冷杉綠<input type="radio" name="role" value="冷杉綠">
                            鈦灰銀<input type="radio" name="role" value="鈦灰銀">
                        </p>
