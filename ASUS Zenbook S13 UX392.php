...
<head>
    ...
    <title>ASUS Zenbook S13 UX392</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS Zenbook S13 UX392</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>13.3"</li>
                            <li>Intel® 第 8 代 Core i7 處理器</li>
                            <li>NVIDIA® GeForce® MX150 顯示卡</li>
                            <li>最大 97% 螢幕佔比</li>
			    <li>輕薄: 1.1kg, 12.9mm</li>
			    <li>最長可達15小時電池續航力</li>
                        </ul>
                        <hr>
                        <h5>NT$ 43000</h5>
