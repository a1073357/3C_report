...
<head>
    ...
    <title>ASUS Chromebook CZ1000DVA</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS Chromebook CZ1000DVA</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>耐刮防撞; 娛樂與學習兼具</li>
                            <li>處理器：MediaTek Kompanio 500(8183) 2.0 GHz</li>
                            <li>記憶體：4G LPDDR4X on board</li>
                            <li>硬碟：64G eMMCz</li>
                            <li>LCD尺寸： 10.5" WUXGA (1920 x 1200) 16:10</li>
			    <li>其他：8M camera、單一方向磁吸Stand兼保護套/快充觸控筆觸控筆充電15秒可用45分鐘</li>
			    <li>作業系統：Google Chrome (非Windows作業系統)</li>
                        </ul>
                        <hr>
                        <h5>NT$ 11888</h5>
                        <hr>
