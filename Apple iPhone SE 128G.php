...
<head>
    ...
    <title>Apple iPhone SE 128G</title>
        ...
        <div class="container">
            <div class="row text-center">
                            ...
                            <div class="upper" id="imgsize3">
                                <div id="demo">
                                    <div id="small-box">
                                        ...
                                        <img src="/img/new_pd1_iPhone_SE3.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPhone SE 128G</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <li>5G 行動網路</li>
                            <li>4.7 吋 Retina HD 顯示器</li>
                            <li>先進的單相機系統，配備 1200 萬像素廣角相機；具備智慧型 HDR 4、攝影風格、人像模式，以及 4K 錄影功能 (最高可達 60 fps)</li>
                            <li>700 萬像素 FaceTime HD 相機，具備智慧型 HDR 4、攝影風格、人像模式，以及 1080p 影片錄製功能</li>
                            <li>A15 仿生晶片，效能表現快如閃電</li>
                            <li>影片播放時間最長可達 15 小時</li>
                            <li>設計經久耐用，並具備 IP67 等級防潑抗水功能</li>
                            <li>主畫面按鈕具備 Touch ID，用於安全認</li>
                            <li>iOS 15 滿載全新功能而來，讓你手中的 iPhone 能比以往做到更多</li>
                        </ul>
                        <hr>
                        <h5>NT$ 14588</h5>
                        <hr>
