...
<head>
    ...
    <title>Apple iPad 9 2021 10.2吋 WIFI 64G</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">Apple iPad 9 2021 10.2吋 WIFI 64G 平板電腦</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>10.2 吋 Retina 顯示器</li>
                            <li>64 位元架構的 A13 仿生晶片</li>
                            <li>800 萬像素相機</li>
                            <li>Touch ID</li>
                            <li>藍牙 4.2 技術</li>
                        </ul>
