...
<head>
    ...
    <title>ASUS Chromebook Tablet CT100</title>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 text-left">
                    <div class="outer1">
                        <a href="#">
                            <h5 class="title">ASUS Chromebook Tablet CT100</h5>
                            <hr>
                        </a>
                        <br><br>
                        <ul>
                            <p>商品特色</p>
                            <li>作業系統與版本 Chrome OS</li>
                            <li>處理器品牌 ARM</li>
                            <li>處理器型號 Cortex-A72</li>
                            <li>主螢幕尺寸 9.7 inch</li>
                            <li>主相機畫素 500 萬畫素</li>
			    <li>RAM記憶體 4 GB</li>
			    <li>ROM儲存空間 32 GB</li>
			    <li>記憶卡 microSD</li>
